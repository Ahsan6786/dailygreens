...
export function Testimonials() {
  return (
    <section id="testimonials" className="py-24 px-6 md:px-12 bg-[#fdfaf6] dark:bg-[#051a05] transition-colors duration-500">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-16">
          <h2 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-4">What Our Guests Say</h2>
          <p className="text-slate-600 dark:text-slate-400">Join thousands of happy diners who prioritze their health.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {testimonials.map((testi, i) => (
            <motion.div
              ...
              viewport={{ once: true }}
              className="p-8 md:p-10 rounded-[40px] bg-white dark:bg-white/5 border border-black/5 dark:border-white/5 shadow-xl shadow-black/[0.02] flex flex-col justify-between"
            >
              <div>
